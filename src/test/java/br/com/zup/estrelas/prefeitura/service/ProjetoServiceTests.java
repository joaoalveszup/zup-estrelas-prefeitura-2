...
public class ProjetoServiceTests {
	...
	public void deveConcluirProjeto() {
		ConclusaoProjetoDTO conclusaoProjetoDTO = new ConclusaoProjetoDTO();
		Secretaria secretaria = new Secretaria();

		conclusaoProjetoDTO.setDataEntrega(LocalDate.of(2020, 12, 01));

		Projeto projeto = new Projeto(1L, "Projeto auxilio", "Auxilio creche", 15000D, secretaria, LocalDate.now(),
				null, false);
	...
	public void naoDeveConcluirProjetoDataTerminoInferiorDataInicio() {
		...
		conclusaoProjetoDTO.setDataEntrega(LocalDate.of(2020, 11, 01));
